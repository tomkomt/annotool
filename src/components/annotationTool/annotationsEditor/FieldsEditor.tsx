...
export const FieldsEditor = (props: FieldsEditorProps) => {
    ...
    const htmlElementIdFactory = (elementName: string, annotation: Annotation) => 
        `${elementName}-${annotation.boundingBox[0]}-${annotation.boundingBox[1]}-${annotation.page}`
                ...
                <div className="container py-5 px-5 mx-0 min-w-full" style={{
                    ...
                    {Array.from(annotations, ([annoKey, annotation]) => (
                        <div 
                            ...
                            key={htmlElementIdFactory('cy-annotation-fields', annotation)} 
                            id={htmlElementIdFactory('cy-annotation-fields', annotation)} 
                            style={{
                                backgroundColor: selectedAnnotation === annoKey ? 'lightblue' : 'initial'
                            }}
                        >
                            <div>
                                <label htmlFor={htmlElementIdFactory('cy-field-name', annotation)} className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
                                <input 
                                    onChange={(event) => onChangeTitle(event, annoKey)} 
                                    type="text" 
                                    id={htmlElementIdFactory('cy-field-name', annotation)} 
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                    placeholder="" 
                                />
                            </div>
                            <div>
                                <label htmlFor={htmlElementIdFactory('cy-field-type', annotation)} className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Type</label>
                                <select onChange={(event) => onChangeType(event, annoKey)} id={htmlElementIdFactory('cy-field-type', annotation)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div className="grid md:grid-cols-10">
                                    <div className="col-span-9">
                                        <div style={{
                                            ...
                                            <label htmlFor={htmlElementIdFactory('cy-field-currency-type', annotation)} className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Currency</label>
                                            <select onChange={(event) => onChangeCurrency(event, annoKey)} id={htmlElementIdFactory('cy-field-currency-type', annotation)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <div>
                                        <svg 
                                            ...
                                            id={htmlElementIdFactory('cy-delete-annotation', annotation)}
